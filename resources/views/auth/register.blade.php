...
<head>
	...
	<title>Register if you are new!</title>
			...
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="cardx fat mt-4">
						<div class="card-body">
							<h4 class="card-title">Register if you are new!</h4>
							<form method="POST" class="my-login-validation" autocomplete="off" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
									...
									<input id="contact" type="text" class="form-control" name="contact"  placeholder="Enter contact">
